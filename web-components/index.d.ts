...
export declare interface DropDownSelection extends SelectOption<unknown> {
}
...
export declare function formatInternational(input: string): string;
...
export declare interface JobData {
    ...
    hosted_view_pixel_url?: string;
}

export declare class JobsClientService {
    private jobTitlesCache;
    searchQuerySuggestions(query: string): Promise<SearchQuery[]>;
    getJobTitlesForClient(clientId: string | number, formId?: string | number): Promise<SelectOption[] | null>;
}
...
export declare function requireJobsClientService(): JobsClientService;
