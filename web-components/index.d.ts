...
export declare class LocationClientService {
    fetchUserLocation(): Promise<SearchLocation>;
    getBrowserCoordinates(): Promise<GeolocationPosition>;
    fetchLocationFromCoordinates(geoLocationCoordinates: Coordinates): Promise<SearchLocation>;
}
...
export declare const SharedApiUrls: {
    ...
    userLocation: (params?: Coordinates | undefined) => string;
